...
Define cómo se determina la versión de un release y cuándo una corrida procede o se omite; qué hace que la imagen de un servicio se reconstruya o se promueva; en qué orden se publican las imágenes, el tag, el release y el despliegue; y qué garantías de atomicidad ofrece cada frontera.

Los términos normativos SHALL / SHALL NOT se mantienen en inglés por ser palabras clave de especificación, igual que los headers de sección.
