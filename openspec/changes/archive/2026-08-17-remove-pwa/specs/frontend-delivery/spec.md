...
<!-- openspec/specs/ está vacío: esta es la primera captura de la capability, por lo que todo
     el estado final se expresa como ADDED y no hay requirements previos que MODIFY o REMOVE.
