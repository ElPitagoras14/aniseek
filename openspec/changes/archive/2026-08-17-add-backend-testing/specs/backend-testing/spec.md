...
<!-- Capability nueva. Gobierna cómo se verifica automáticamente el backend: qué se ejecuta,
     contra qué base, cómo se aísla una prueba de otra y qué debe poder comprobarse.
