...
<!-- Capability nueva. Complementa a `frontend-delivery` sin solaparse: aquella gobierna cómo
     llega /config.js al navegador (caching, ausencia de service worker); esta gobierna cómo se
     produce ese archivo y cómo se interpreta su contenido.
