...
<!-- Capability nueva. Gobierna cómo los servicios llegan a la base: cómo se expresan las
     consultas, cómo viaja la conexión, cómo se delimita una unidad de trabajo y cómo se
     configura la conexión. No se solapa con `database-migrations`, que gobierna cómo evoluciona
     el esquema, ni con `backend-testing`, que gobierna cómo se verifica este comportamiento.
